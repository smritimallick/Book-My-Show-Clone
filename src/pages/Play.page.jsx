            ...
            <div className="flex flex-wrap">
              ...
              <div className="w-1/2 md:w-1/3 lg:w-3/12 my-3 flex items-center">
                <Poster
                  ...
                  title="Suhani Shah Kahani - INDIA Tour"
                  subtitle="Comedy Shows | Hindi  | 13yrs + | 1hr"
                />
              </div>
              <div className="w-1/2 md:w-1/3 lg:w-3/12 my-3 flex items-center">
                <Poster
              ...
              <div className="w-1/2 md:w-1/3 lg:w-3/12 my-3 flex items-center">
                <Poster
                  ...
                  title="DJ Snake Sunburn Arena"
                  subtitle="EDM Night | English | 15yrs + | 4hrs "
                />
              </div>
              <div className="w-1/2 md:w-1/3 lg:w-3/12 my-3 flex items-center">
                <Poster
                  isPlay={true}
                  src="https://assets-in.bmscdn.com/discovery-catalog/events/tr:w-400,h-600,bg-CCCCCC:w-400.0,h-660.0,cm-pad_resize,bg-000000,fo-top:ote-U3VuLCAxMSBEZWM%3D,ots-29,otc-FFFFFF,oy-612,ox-24:q-80/et00345870-khrmuaqcaq-portrait.jpg"
                  title="Tuglaq - An Online Play"
                  subtitle="Historical Play | Hindi | 6yrs + | 1hr 30mins"
                />
              </div>
              <div className="w-1/2 md:w-1/3 lg:w-3/12 my-3 flex items-center">
                <Poster
                  isPlay={true}
                  src="https://assets-in.bmscdn.com/discovery-catalog/events/tr:w-400,h-600,bg-CCCCCC:w-400.0,h-660.0,cm-pad_resize,bg-000000,fo-top:ote-U3VuLCAxMSBEZWM%3D,ots-29,otc-FFFFFF,oy-612,ox-24:q-80/et00344360-rybkmwtmlf-portrait.jpg"
                  title="12 Inches"
                  subtitle="Comedy Shows | Hindi, English | 18yrs + | 1hr 30mins"
                />
              </div>
            </div>
          </div>
